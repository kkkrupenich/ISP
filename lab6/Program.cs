...
namespace Cars
{
    ...
    sealed class Lamborghini : Car, IPrintable, IComparable<Lamborghini>
    {
        ...
        public int CompareTo(Lamborghini other)
        {
    ...
    class Program
    {
        ...
        {
            Lamborghini lamb1 = new Lamborghini("Huracan EVO", 1422, 2, 80, 14, 270, 520);
            Lamborghini lamb2 = new Lamborghini("Aventador SVJ", 1575, 2, 80, 16, 300, 570);
            Lamborghini lamb3 = new Lamborghini("Gallardo", 1356, 2, 80, 15, 250, 490);
            Lamborghini[] lambos = new Lamborghini[] {lamb1, lamb2, lamb3};

            foreach(Lamborghini i in lambos) //before Huracan Aventador Gallardo
            {
                i.ShortInfo();
            }
            Array.Sort(lambos);
            foreach(Lamborghini i in lambos) //after Gallardo Huracan Aventador
            {
                i.ShortInfo();
            }
            /*
